...
DROP TABLE IF EXISTS {{zone_name}}.iceberg_demos.sensors_v1_iceberg WITH FILES;
DROP TABLE IF EXISTS {{zone_name}}.iceberg_demos.sensors_v2_iceberg WITH FILES;
DROP TABLE IF EXISTS {{zone_name}}.iceberg_demos.sensors_v3_iceberg WITH FILES;
