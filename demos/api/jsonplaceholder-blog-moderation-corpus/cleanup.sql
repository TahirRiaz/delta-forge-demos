...
DROP DELTA TABLE IF EXISTS {{zone_name}}.content_moderation.posts_silver WITH FILES;

DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.content_moderation.posts_bronze WITH FILES;

DROP API ENDPOINT IF EXISTS {{zone_name}}.blog_moderation.blog_posts;

DROP CONNECTION IF EXISTS blog_moderation;

DROP SCHEMA IF EXISTS {{zone_name}}.content_moderation;
