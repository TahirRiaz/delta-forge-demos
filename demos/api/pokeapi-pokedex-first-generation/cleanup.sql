...
DROP DELTA TABLE IF EXISTS {{zone_name}}.game_ref.pokedex_silver WITH FILES;

DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.game_ref.pokedex_bronze WITH FILES;

DROP API ENDPOINT IF EXISTS {{zone_name}}.pokedex_api.first_generation;

DROP CONNECTION IF EXISTS pokedex_api;

DROP SCHEMA IF EXISTS {{zone_name}}.game_ref;
