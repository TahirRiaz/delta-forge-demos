...
DROP GRAPH IF EXISTS {{zone_name}}.karate.karate_club;

-- STEP 2: Drop Delta tables
DROP DELTA TABLE IF EXISTS {{zone_name}}.karate.vertices WITH FILES;
DROP DELTA TABLE IF EXISTS {{zone_name}}.karate.edges WITH FILES;
...
DROP SCHEMA IF EXISTS {{zone_name}}.karate;
