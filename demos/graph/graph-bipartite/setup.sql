...
-- ============================================================================
CREATE DELTA TABLE IF NOT EXISTS {{zone_name}}.graph.entities (
    id              BIGINT,
    name            STRING,
    entity_type     STRING,
    genre           STRING,
...
GRANT ADMIN ON TABLE {{zone_name}}.graph.entities TO USER {{current_user}};

-- 25 subscribers (id 1-25)
INSERT INTO {{zone_name}}.graph.entities VALUES
...
-- ============================================================================
CREATE DELTA TABLE IF NOT EXISTS {{zone_name}}.graph.ratings (
    id              BIGINT,
    src             BIGINT,
    dst             BIGINT,
    weight          DOUBLE,
...
GRANT ADMIN ON TABLE {{zone_name}}.graph.ratings TO USER {{current_user}};

INSERT INTO {{zone_name}}.graph.ratings VALUES
...
-- ============================================================================
CREATE GRAPH IF NOT EXISTS {{zone_name}}.graph.movie_recs
    VERTEX TABLE {{zone_name}}.graph.entities ID COLUMN id NODE TYPE COLUMN entity_type NODE NAME COLUMN name
    EDGE TABLE {{zone_name}}.graph.ratings SOURCE COLUMN src TARGET COLUMN dst
