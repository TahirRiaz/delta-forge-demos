...
DROP GRAPH IF EXISTS {{zone_name}}.graph_demos.research_network;

-- STEP 2: Drop Delta tables (WITH FILES removes physical data too)
DROP DELTA TABLE IF EXISTS {{zone_name}}.graph_demos.collaborations WITH FILES;
DROP DELTA TABLE IF EXISTS {{zone_name}}.graph_demos.researchers WITH FILES;
