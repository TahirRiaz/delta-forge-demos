...
-- ============================================================================
CREATE DELTA TABLE IF NOT EXISTS {{zone_name}}.graph.ports (
    id              BIGINT,
    name            STRING,
    region          STRING,
    capacity_teu    INT,
...
GRANT ADMIN ON TABLE {{zone_name}}.graph.ports TO USER {{current_user}};

INSERT INTO {{zone_name}}.graph.ports VALUES
...
-- ============================================================================
CREATE DELTA TABLE IF NOT EXISTS {{zone_name}}.graph.routes (
    id              BIGINT,
    src             BIGINT,
    dst             BIGINT,
    distance_nm     DOUBLE,
...
GRANT ADMIN ON TABLE {{zone_name}}.graph.routes TO USER {{current_user}};

-- ============================================================================
-- Batch 1: Asia intra-regional trunk routes (16 edges)
-- ============================================================================
INSERT INTO {{zone_name}}.graph.routes VALUES
...
-- GRAPH DEFINITION
-- ============================================================================
CREATE GRAPH IF NOT EXISTS {{zone_name}}.graph.shipping_network
    VERTEX TABLE {{zone_name}}.graph.ports ID COLUMN id NODE TYPE COLUMN region NODE NAME COLUMN name
    EDGE TABLE {{zone_name}}.graph.routes SOURCE COLUMN src TARGET COLUMN dst
