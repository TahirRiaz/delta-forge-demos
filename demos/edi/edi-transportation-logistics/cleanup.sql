...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi.logistics_messages WITH FILES;
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi.logistics_materialized WITH FILES;
