...
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi.tradacoms_messages WITH FILES;
DROP EXTERNAL TABLE IF EXISTS {{zone_name}}.edi.tradacoms_materialized WITH FILES;
