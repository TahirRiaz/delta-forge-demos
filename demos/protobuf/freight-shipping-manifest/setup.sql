...
DETECT SCHEMA FOR TABLE {{zone_name}}.protobuf_freight.shipments;
...
DETECT SCHEMA FOR TABLE {{zone_name}}.protobuf_freight.shipment_packages;
...
DETECT SCHEMA FOR TABLE {{zone_name}}.protobuf_freight.shipment_tracking;
